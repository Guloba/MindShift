...
class BarChartSample1State extends State<BarChartSample1> {
  final Color barBackgroundColor = Colors.orange.shade50;
        ...
        switch (i) {
          case 0:
            return makeGroupData(
                0,
                double.parse(((tCalorie / rCalorie) * 100).toStringAsFixed(2)) >
                        100
                    ? 100
                    : double.parse(
                        ((tCalorie / rCalorie) * 100).toStringAsFixed(2)),
                isTouched: i == touchedIndex);
          case 1:
            return makeGroupData(
                1,
                double.parse(((tCarbs / rCarbs) * 100).toStringAsFixed(2)) > 100
                    ? 100
                    : double.parse(
                        ((tCarbs / rCarbs) * 100).toStringAsFixed(2)),
                isTouched: i == touchedIndex);
          case 2:
            return makeGroupData(
                2,
                double.parse(((tProtein / rProtein) * 100).toStringAsFixed(2)) >
                        100
                    ? 100
                    : double.parse(
                        ((tProtein / rProtein) * 100).toStringAsFixed(2)),
                isTouched: i == touchedIndex);
          case 3:
            return makeGroupData(
                3,
                double.parse(((tFat / rFat) * 100).toStringAsFixed(2)) > 100
                    ? 100
                    : double.parse(((tFat / rFat) * 100).toStringAsFixed(2)),
                isTouched: i == touchedIndex);
          case 4:
            return makeGroupData(
                4,
                double.parse(((tSugars / rSugars) * 100).toStringAsFixed(2)) >
                        100
                    ? 100
                    : double.parse(
                        ((tSugars / rSugars) * 100).toStringAsFixed(2)),
                isTouched: i == touchedIndex);
          case 5:
            return makeGroupData(
                5,
                double.parse(((tCholesterol / rCholesterol) * 100)
                            .toStringAsFixed(2)) >
                        100
                    ? 100
                    : double.parse(((tCholesterol / rCholesterol) * 100)
