  ...
  Widget build(BuildContext context) {
    ...
    List<MealsListData> mealsListData = [
      MealsListData(
        ...
        meals: <String>['Target:', targetbreakfast.toStringAsFixed(0) + ' Kcal'],
        startColor: '#FA7D82',
        endColor: '#FFB295',
        index: 0,
      ),
      MealsListData(
        ...
        meals: <String>['Target:', targetlunch.toStringAsFixed(0) + ' Kcal'],
        startColor: '#48D1CC',
        endColor: '#20B2AA',
        index: 1,
      ),
      MealsListData(
        ...
        meals: <String>['Target:', targetsnack.toStringAsFixed(0) + ' Kcal'],
        startColor: '#FE95B6',
        endColor: '#FF5287',
        index: 2,
      ),
      MealsListData(
        ...
        meals: <String>['Target:', targetdinner.toStringAsFixed(0) + ' Kcal'],
        startColor: '#6F72CA',
        endColor: '#1E1466',
        index: 3,
      ),
